"""
Taken from torchvision ResNet model for ImageNet.
License: BSD 3-clause
https://github.com/pytorch/vision/blob/8541c214740f9cfaf2e60ad1579faf6f4af1257b/torchvision/models/resnet.py
"""
import torch
...
def conv3x3(in_planes: int, out_planes: int, stride: int = 1, groups: int = 1, dilation: int = 1) -> BinaryConv2d:
    """3x3 convolution with padding"""
    return BinaryConv2d(in_planes, out_planes, kernel_size=3, stride=stride,
                     padding=dilation, groups=groups, bias=False, dilation=dilation)


def conv1x1(in_planes: int, out_planes: int, stride: int = 1) -> BinaryConv2d:
    """1x1 convolution"""
